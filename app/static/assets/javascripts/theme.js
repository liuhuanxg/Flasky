						...
						'<div class="center-sign">',
							'<div class="panel panel-sign">',
								'<div class="panel-body">',
									'<form>',
										'<div class="current-auth text-center">',
											'<img id="LockUserPicture" src="{{picture}}" alt="John Doe" class="img-circle auth-image" />',
											'<h2 id="LockUserName" class="auth-name text-dark m-none">{{username}}</h2>',
											'<p  id="LockUserEmail" class="auth-email m-none">{{email}}</p>',
										'</div>',
